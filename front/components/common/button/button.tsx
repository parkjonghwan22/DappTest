...
const backgroundColors: StyledOptions = {
  ...
  export const Button = ({ onClick, type, color, size, fontSize, disabled, children }: ButtonProps) => {
    const buttonStyled: string = `flex items-center justify-center order-0 py-2.5 px-3 mr-3 focus:outline-none hover:bg-gray-400 rounded text-white mt-4 md:mt-0 transition duration-300 ease-in-out`;
